...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--no_lsgan', action='store_true', help='do *not* use least square GAN, if false, use vanilla GAN') #MSEloss
        #parser.add_argument('--no_lsgan', action='store_false', help='do *not* use least square GAN, if false, use vanilla GAN') #BCEloss
