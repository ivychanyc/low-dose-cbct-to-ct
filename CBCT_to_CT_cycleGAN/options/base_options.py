...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        #parser.add_argument('--dataroot', type=str, default='./datasets/MR2CT/', #Ivy commented this 21.06.2021
        #                     help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--dataroot', type=str, default='/data/Unpaired_MR_to_CT_Image_Synthesis-master/data/datasets/MR2CT/',
                             help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        #parser.add_argument('--gpu_ids', type=str, default='2', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU') #Ivy commneted on 22.06.2021
        parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU') #Ivy commented on 03.08.2021
        ...
        #parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints', help='models are saved here') # Ivy commented on 21.06.2021
        parser.add_argument('--checkpoints_dir', type=str, default='/data/Unpaired_MR_to_CT_Image_Synthesis-master/checkpoints', help='models are saved here')
    ...
    def parse(self):
        ...
        if len(opt.gpu_ids) > 0:
            print("GPU is here",opt.gpu_ids[0])
            torch.cuda.set_device(opt.gpu_ids[0]) #Ivy added this line 03.08.2021
            #torch.cuda.set_device(opt.gpu_ids[0]) #Ivy commented this line 03.08.2021
