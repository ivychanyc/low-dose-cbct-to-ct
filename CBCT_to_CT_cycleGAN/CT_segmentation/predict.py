...
def get_args():
    ...
    #parser.add_argument('--input', '-i', metavar='/data/Unpaired_MR_to_CT_Image_Synthesis-master/data/datasets/MR2CT/trainB_temp/', nargs='+',
    #                    help='filenames of input images', required=True)

    parser.add_argument('--output', '-o', metavar='INPUT', nargs='+',
                        help='filenames of ouput images')
    #parser.add_argument('--output', '-o', metavar='/data/Unpaired_MR_to_CT_Image_Synthesis-master/data/datasets/MR2CT/trainB_temp/', nargs='+',
    #                    help='filenames of ouput images')
